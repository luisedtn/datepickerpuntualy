...
import { Directive, ElementRef, EventEmitter, Events, HostListener, Input, Output, ViewChild, ViewEncapsulation, forwardRef } from "@angular/core";
...
export class DatePickerDirective {
  ...
  constructor(
    ...
    this.event.subscribe('abrirDatePicker', (node) => {
      console.log('ABRIRDATEPICKER');
      this.open();
    });
  }
